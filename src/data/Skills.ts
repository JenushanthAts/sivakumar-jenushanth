export const skillsSet = [
  ...
  },
  {
    ...
    values: [
      ...
      {
        title: "Windows",
        src: "https://icon.icepanel.io/Technology/svg/Windows-11.svg",
      },
      {
        title: "VS Code",
      ...
      {
        title: "Stripe",
        src: "https://cdn.iconscout.com/icon/free/png-512/free-stripe-logo-icon-download-in-svg-png-gif-file-formats--technology-social-media-vol-6-pack-logos-icons-2945188.png?f=webp&w=512",
      },
      {
        title: "Aws",
