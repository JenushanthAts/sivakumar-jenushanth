...
const Contact = () => {
  return (
    <div className="contact-section">
      ...
      <p>
        I’m available on almost every social media platform! Feel free to reach
        out to me, and I’ll respond within 24 hours. Whether you’re looking for
        guidance, collaboration, or just a conversation about technology, I’d be
        happy to assist you. Let’s connect and work together to bring innovative
        ideas to life!
      </p>
